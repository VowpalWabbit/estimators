    ...
    def simulator():
        for i in range(1000000):
            ...
            yield  {'p_log': 0.5,
                    ...
                    'p_pred': 0.2 if chosen == 0 else 0.8}
    expected = (0.15, 0.25)
    assert_interval_is_within(gaussian.Interval, simulator, expected)
    assert_interval_is_within(clopper_pearson.Interval, simulator, expected)
    assert_interval_is_within(cressieread.Interval, simulator, expected)
